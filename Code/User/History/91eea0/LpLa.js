...
// class Project{
//   renderProj(projectName){
// const project=document.createElement('button')
//   project.className='btn btn-secondary btn-block'
...
//   const addProject= document.getElementById('confirmAddProject')
//   addProject.addEventListener('click',()=>{
//     const projectName=document.getElementById('projectNameInput')
//     this.project.push(projectName)
//     projects.update(this.project)
//   })
// }
  initNote() {
    ...
    let id=0
    const firstNote = new Note('noteName', 'noteDescription',id);
